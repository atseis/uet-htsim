...
public:
    ...
    void dump_idmap(const std::string& filename);
...
public:
    ...
    string _name;
    static void dump_idmap(const std::string& filename) { _logged_manager.dump_idmap(filename); }
...
public:
    ...
    virtual void logEvent(PacketFlow& flow,
                          Logged& location,
                          FlowEvent ev,
                          mem_b bytes,
                          uint64_t pkts) = 0;
...
public:
    ...
    virtual void logQcnQueue(QcnQueue& src,
                             QcnQueueEvent ev,
                             double var1,
                             double var2,
                             double var3) = 0;
